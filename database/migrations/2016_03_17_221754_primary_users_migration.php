...
class PrimaryUsersMigration extends Migration
{
    ...
    public function up()
    {
        DB::table('users')->insert([
            ...
            // Respondants
            ['first_name' => 'DeRay',   'last_name' => 'Mckesson',      'slug' => 'deray-mckesson',     'email' => 'deray@derayformayor.com',       'password' => Hash::make('derayishere2016'),    'from' => 'Baltimore, MD',       'facebook_id' => null,                  'respondant' => true,       'created_at' => Carbon::now()->toDateTimeString(),      'updated_at' => Carbon::now()->toDateTimeString()], // user_id = 5
        ]);
